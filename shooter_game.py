...
win = font1.render('ПОБЕДА!', True, (255, 200, 0))
...
winner = mixer.Sound('winner1.ogg')
winner.set_volume(0.3)
loser = mixer.Sound('lose1.ogg')
loser.set_volume(0.3)
